...
const Activities = Loadable({loader: () => import(/*webpackChunkName:'Activities'*/'@/views/activities'),loading: Loading});
...
export default [
  ...
  { path: "/activities", component: Activities, roles: ["admin","editor","guest"] },
