...
import { generatePreviousMonthDate } from "../../../../utils/date";
...
class LineChartMonth extends Component {
  ...
  state = {
    chart: null,
    previousMonth: generatePreviousMonthDate()
  };
  ...
  setOptions({ except, actual } = {}) {
    console.log(actual);

    this.state.chart.setOption({
      backgroundColor: "#fff",
      xAxis: {
        data: this.state.previousMonth,
        boundaryGap: false,
        axisTick: {
          show: false,
        },
...
export default connect(state=>state.app)(LineChartMonth);